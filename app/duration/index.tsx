...
const styles = StyleSheet.create({
  ...
  durationCard: { width: '47%', position: 'relative', marginBottom: Spacing.md + 4 },
  cardEdge: { position: 'absolute', bottom: 0, left: 0, right: 0, height: 4, borderBottomLeftRadius: Radii.lg, borderBottomRightRadius: Radii.lg },
  cardMain: { position: 'relative', borderRadius: Radii.lg, borderWidth: 2, padding: Spacing.lg, alignItems: 'center', justifyContent: 'center', zIndex: 1 },
